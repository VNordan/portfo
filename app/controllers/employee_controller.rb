class EmployeeController < ApplicationController
  ...
  # def vacancies
  #   @t = Date.today                       #берём текущую дату
  #   @a = @t.prev_year(2).year.to_s+'-'+@t.strftime("%m")+'-15'
  #   @vacancy = EmployeeStatsDepartments.where(month: @a)
  # end
  ...
  #   @vacancy = EmployeeStatsDepartments.where(month: @a)
    ...
    #   if !stro.save
    #     @error = stro.errors.full_messages.first
    #     render 'vacancies'
    #   end
    # end    
